...
async function seed() {
  ...
  await PostImage.bulkCreate([
    {
      url: 'https://via.placeholder.com/300x200.png?text=Imagen+1',
      PostId: post1.id
    },
    {
      url: 'https://via.placeholder.com/300x200.png?text=Imagen+2',
      PostId: post1.id
    },
    {
      url: 'https://via.placeholder.com/300x200.png?text=Reflexion',
      PostId: post2.id
    }
  ]);
